...
/*!
* @abstract 设置远端音频 Track 播放音量。范围从 0 ~ 10，10 为最大 (only for MangGouTV)
*
* @discussion 需要发布成功后才可以执行 setRemote 操作。本次操作仅对远端音频播放音量做调整，远端音量回调为远端音频数据的原始音量，不会基于本设置做相应调整。
*
* @warning 部分机型调整音量放大会出现低频噪音
...
/*!
 * @abstract 订阅由 userId 指定的视频 track。(only for MangGou)
 *
 * @since v3.0.1
 */
...
/*!
 * @abstract 取消订阅由 userId 指定的视频 track。(only for MangGou)
 *
 * @since v3.0.1
 */
